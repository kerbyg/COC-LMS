...
function saveQuiz($input, $userId) {
    ...
    try {
        ...
        // Insert quiz
        $quizColumns = ['user_teacher_id', 'subject_id', 'lesson_id', 'quiz_title', 'quiz_description', 'time_limit', 'passing_rate', 'max_attempts', 'total_points', 'status', 'created_at', 'updated_at'];
