...
echo "\n=== Checking lesson_id column details ===\n";
...
echo "\n=== Testing INSERT with NULL lesson_id ===\n";
...
try {
    ...
    echo "✓ INSERT with NULL lesson_id successful! New ID: $newId\n";

    $check = db()->fetchOne("SELECT quiz_id, lesson_id FROM quiz WHERE quiz_id = ?", [$newId]);
    echo "Record: quiz_id={$check['quiz_id']}, lesson_id=" . ($check['lesson_id'] ?: 'NULL') . "\n";
} catch (Exception $e) {
