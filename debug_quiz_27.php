...
foreach ($questions as $q) {
    ...
    // Get options
    echo "Options:\n";
    $options = db()->fetchAll("SELECT * FROM question_option WHERE quiz_question_id = ? ORDER BY order_number", [$q['questions_id']]);
